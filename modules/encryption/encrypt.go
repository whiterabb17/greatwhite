...
func RunE(cipherKey []byte, msg string) string {
...
func RunD(cipherKey []byte, msg string) string {
...
func runTest(toEncrypt string) {
	...
	//if *encryptPtr {
	encryptedString = RunE(cipherKey, toEncrypt)
	//}

	//if *decryptPtr {
	RunD(cipherKey, encryptedString)
	//}
}
